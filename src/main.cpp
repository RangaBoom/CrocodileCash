...
unsigned int nTargetSpacing = 1 * 30; // CrocodileCash - 30 second blocks
static const int64_t nInterval = nTargetTimespan / nTargetSpacing;
static const int64_t nDiffChangeTarget = 1;

unsigned int nStakeMinAge = 2 * 60 * 60; // 2 hours
unsigned int nStakeMaxAge = -1;  // unlimited
unsigned int nModifierInterval = 10 * 60; // CrocodileCash - time to elapse before new modifier is computed
...
const string strMessageMagic = "CrocodileCash Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight+1 <= 1)
    {
        ...
        else if(pindexBest->nHeight+1 >= 2  && pindexBest->nHeight+1 <= 80640)
    {
        nSubsidy = 15 * COIN;
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    // proof of stake rewards. POS begins at block 1440
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // CrocodileCash: check proof-of-stake block signature
...
// CrocodileCash: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CrocodileCash", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1502246618;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 37778612;
       ...
       if (false && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0xf3bfee8cfab6f6dc5c7f970fed15960ae5a2a9d0142ec4ceae05776361ef1ebd"));
